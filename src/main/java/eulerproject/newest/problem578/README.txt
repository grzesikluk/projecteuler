Any positive integer can be written as a product of prime powers: p1^a1 × p2^a2 × ... × pk^ak,
...
For example, 1, 2, 15=3×5, 360=2^3×3^2×5 and 1000=2^3×5^3 are decreasing prime power integers.
